...
#' @param ttname a character string of the name of the column in "data" that corresponds to a dummy coded treatment indicator (tt). 0 for the control condition and 1 for the intervention condition.
#' @param Rname a character string of the name of the column in "data" that corresponds to a dummy coded subgroup indicator (R). 0 for the reference subgroup and 1 for the focal subgroup.
...
#'
#' @return A data frame containing the results (estimates and 95% confidence intervals) for the mediated moderation (MedMod) and remaining moderation (RemainMod), which decompose the total moderation (TotMod). The output also includes results for the expected potential outcomes in their definitions.
#' These include the expected potential outcomes of each subgroup under each treatment assignment (Yt1r1, Yt1r0, Yt0r1, Yt0r0), and the expected potential outcomes of the focal subgroup if the potential mediator distribution for them were shifted to be equivalent to that of the reference subgroup (Yt1r1.Mt1r0, Yt0r1.Mt0r0). In the output data frame, the confidence intervals are the columns with names ending with "_interval.1" and "_interval.2".
